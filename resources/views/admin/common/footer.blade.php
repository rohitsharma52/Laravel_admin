<footer class="pc-footer">
          <div class="footer-wrapper container-fluid">
            <div class="row">
              <div class="col-sm-6 my-1">
                <p class="m-0">Made with &#9829; by Rohit Sharma</p>
              </div>
        ...
        <script src="{{asset('admin/js/plugins/jsvectormap.min.js')}}"></script>
        <script src="{{asset('admin/js/plugins/world.js')}}"></script>
        <script src="{{asset('admin/js/plugins/world-merc.js')}}"></script>
        ...
        <!-- Mirrored from html.phoenixcoded.net/light-able/bootstrap/dashboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 05:42:51 GMT -->
        </html>
